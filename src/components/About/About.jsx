...
const About = () => {
  ...
  return (
    <div className="relative">
      ...
      <motion.section
        ref={aboutRef}
        className="bg-[#0E0E0E] text-white py-12 md:py-16 lg:py-20 xl:py-24  xl:max-w-[70%] lg:max-w-[90%] md:max-w-[100%] sm:max-w-[100%] mx-auto rounded-xl relative z-10"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {[
                    { href: "https://www.facebook.com/wwwrubenalfonsocom/?_rdr", icon: FacebookIcon, alt: "Facebook", label: "Síguenos en Facebook - Rubén Alfonso Real Estate" },
                    { href: "https://www.instagram.com/comprandoconespana/", icon: InstagramIcon, alt: "Instagram", label: "Síguenos en Instagram - Comprando con España" },
                    { href: "https://www.linkedin.com/in/ruben-alfonso-7143334/", icon: LinkedInIcon, alt: "LinkedIn", label: "Conéctate en LinkedIn - Rubén Alfonso" },
                    { href: "https://www.behance.net/rubendario", icon: BehanceIcon, alt: "Behance", label: "Ver portfolio en Behance - Rubén Darío" },
                    { href: "#", icon: DribbbleIcon, alt: "Dribbble", label: "Dribbble" }
                  ].map((social, index) => (
                    <motion.a
                      key={index}
                      href={social.href}
